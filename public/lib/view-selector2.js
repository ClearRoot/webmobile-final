...
gapi.analytics.ready(function() {
  gapi.analytics.createComponent('ViewSelector2', {
    ...
    render_: function() {
      ...
      const properties = this.properties || [{name: '(Empty)', id: ''}];
      const views = this.views || [{name: '(Empty)', id: ''}];
